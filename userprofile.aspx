<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="userprofile.aspx.cs" Inherits="StudentInformationForm.userprofile" %>
                       ...
                       <br /> <center><span class="badge text-bg-primary">Login credentials</span></center><br />
                          ...
                          <div class="row">       
                            <div class="col-md-4">
                               ...
                               <div class="form-group">
                                   <asp:TextBox CssClass="form-control" ID="TextBox10" runat="server" placeholder="Login ID" TextMode="SingleLine"></asp:TextBox>
                               </div>
                            </div>
                              ...
                              <div class="col-md-4">
                                  <label>Old Password</label>
                                       <div class="form-group">
                                           <asp:TextBox CssClass="form-control" ID="TextBox11" runat="server" placeholder="Password" TextMode="Password"></asp:TextBox> <br />
                                       </div>
                               </div>
                               ...
                               <div class="col-md-4">
                                  <label> New Password</label>
                                       <div class="form-group">
                                           <asp:TextBox CssClass="form-control" ID="TextBox12" runat="server" placeholder="Password" TextMode="Password"></asp:TextBox> <br />
                                       </div>
                               </div>
                        ...
                        <div>
                            ...
                            <%--</div>--%>
                             ...
                             <div class="form-group">
                                 ...
                                 <input class="btn btn-success btn-lg d-grid gap-2 col-6 mx-auto" id="Button1" type="button" value="Update" /><br />
                  ...
                  <div class="card">
                    <div class="body">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <center>
                                <img width="150px"src="assets/book-stack.png" />
                                </center>
                            </div>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <h3>Your issued Books</h3>
                                        ...
                                        <asp:Label  class="badge text-bg-primary" ID="Label2" runat="server" Text="Your issued books"></asp:Label>
